...
import {addArrIntAnswer, removeArrIntAnswer} from "../../../../../store/reducer/enteredQuiz/enteredQuizSlice";
...
export const CheckboxOption: FC<PropsType> = (
  {
    questionId,
    index,
    value,
  ...
  return (
    <div key={`${questionId}_${index}`} className={styles['answer__variant-input']}>
