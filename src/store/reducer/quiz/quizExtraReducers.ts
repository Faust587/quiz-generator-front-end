import {
  createQuestion, deleteQuestion, deleteQuestionAttachment,
  deleteQuizByCode,
  fetchQuizById,
  refreshQuizCode,
  updateQuestion,
  updateQuizParametersById, uploadQuestionAttachment
} from './quizThunks';
import {compare, TInitialQuizState} from './quizSlice';
import {ActionReducerMapBuilder} from '@reduxjs/toolkit';

export const quizExtraReducers = (builder: ActionReducerMapBuilder<TInitialQuizState>) => {
